...
따라서, 본 연구는 `생성 모델`을 활용한 도로 노면 불량 `이미지 증강`과 `포트홀 탐지` 성능 향상을 목표로 함
...
- Stable Diffusion 이용한 이미지 생성
<br><br><br>
<p align="center">
  <img src="https://github.com/junhjun/IN-ISP/assets/53384975/97e0859e-8731-40d2-af70-23e576615cc1" width="1000">
</p>
